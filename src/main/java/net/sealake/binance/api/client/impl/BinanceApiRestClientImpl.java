...
import static net.sealake.binance.api.client.impl.BinanceApiServiceGenerator.createService;
import static net.sealake.binance.api.client.impl.BinanceApiServiceGenerator.executeSync;
